...
class architceture_relief (object) :
    def __init__(self, sess, args):
        ...
        self.dataset_name = '/home/luc-s/Vidéos/lucry suite/dossier article/geospatiale/dossier'
   ...
   def test(self):
    ...
    test_A_files = glob('/home/luc-s/Vidéos/Lucry suite/dossier article/geospatiale/dossier/teste_Architecture/*.*')
    test_B_files = glob('/home/luc-s/Vidéos/Lucry suite/dossier article/geospatiale/dossier/teste_geospatial/*.*')
